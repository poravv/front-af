    ...
    return (
        <div >
            ...
            <Form
                ...
                <Form.Item label='Notificar en' name="notificar" rules={[{ required: true, message: 'Cargue cantidad minima para notificar', },]}>
                    <Input type="number" placeholder='Notificar en' value={notificar} onChange={(e) => setNotificar(e.target.value)} />
                </Form.Item>
                <Form.Item
                    style={{ margin: `20px` }}>
